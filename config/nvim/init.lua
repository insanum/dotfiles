...
require('lazy').setup({
  ...
  require 'kickstart.plugins.lightspeed',
...
autocmd insanum BufNewFile,BufReadPost
    ...
    \ set cindent cinoptions=>s,e0,n0,f0,{0,}0,^0,:0,=s,gs,hs,ps,t0,+s,c1,(0,us,)20,*30,Ws
]])

-- jump/edit previous buffer
vim.keymap.set('n', '<C-b>', '<cmd>e #<CR>')

-- jump between buffers in a window with [C-<hjkl>]
...
-- lightspeed is sooooooooo much better than hop
-- => s<char1>[<char2>]<space|tab|<signature>>
