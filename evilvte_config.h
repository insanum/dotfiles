...
#define BACKGROUND_SCROLLABLE  FALSE
...
#define COLOR_STYLE USER_CUSTOM  /* Options: LINUX, RXVT, TANGO, XTERM, ZENBURN,      */
...
#define MENU_MATCH_STRING_EXEC "/usr/bin/chromium"
...
#define MENU_CUSTOM            "Copy", "Separator", "Paste", "Separator", "Select font", "Background tint", "Adjust saturation", "Reset terminal", "Reset and clear", "Separator", "Quit"
